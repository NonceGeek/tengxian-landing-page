...
export default function AISaaS({ dict }: AISaaSProps) {
  return (
    <FadeInUp>
      <section id="ai-saas" className="relative overflow-hidden w-full mx-auto min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] flex items-center justify-center pb-20 sm:pb-28 md:pb-36 lg:pb-40 px-4 sm:px-6 md:px-8">
        {/* 背景渐变光晕 - 移动端优化 */}
            ...
            <div className="flex-1 text-center md:text-left flex flex-col justify-center">
              ...
              <FadeInUp delay={0.7}>
                <div className="flex gap-4 flex-wrap">
                  <a href="https://home.ai-saas.rootmud.xyz/" target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-base group relative overflow-hidden btn-shimmer">
                    👀&nbsp;&nbsp; See More Details...
                  </a>
                </div>
              </FadeInUp>
